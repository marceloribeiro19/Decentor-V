...
def fullrange_test_activation_functions():
    ...
    for func in functions:
        ...
        print(f"Testing {func} activation function:")
        while input < 10.5:
            output = node_activation_function(input, func)
            print(f"{output:.6f}, ", end="")  # <-- 6 casas decimais
            input = input + 0.1
        print()
...
def test_loss_derivatives():
    ...
    test_cases = [(0.0, 0.1), (0.5, 0.5), (1.0, 0.9), (0.0, 0.9), (1.0, 0.1)]
...
if __name__ == "__main__":
    #fullrange_test_activation_functions()
