...
void q_back_prop(float* input_sample, float* out_trg, ann_model* model, ann_model_q7* model_q7, forward_propagation_buffers* fwd_p, backward_propagation_buffers* bwd_p, int8_t* q_input_sample,int8_t* q_layer_out_0,int8_t* q_layer_out_1,int8_t* q_layer_out_2,int* output_format,float learning_rate);
